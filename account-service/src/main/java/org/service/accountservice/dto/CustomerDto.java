...
public class CustomerDto {
    ...
    @Schema(description = "Name of the customer", example = "User Name")
    ...
    @Schema(description = "Email of the customer", example = "username@gmail.com")
    ...
    @Schema(description = "Accounts of the customer", example = "Accounts details")
    @NotEmpty(message = "Accounts should not be empty")
