package org.service.loans.controller;
...
import org.service.loans.constants.LoansConstants;
import org.service.loans.service.ILoansService;
import org.service.loans.dto.ErrorResponseDto;
import org.service.loans.dto.LoansContactInfoDto;
import org.service.loans.dto.LoansDto;
import org.service.loans.dto.ResponseDto;
...
public class LoansController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("X-Request-Trace-Id") String correlationId, @RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
        log.info("Correlation id in the cards service {} ", correlationId);
